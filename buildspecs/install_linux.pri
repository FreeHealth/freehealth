...
message( No installation available in Debug mode )
 ...
 CONFIG(LINUX_INTEGRATED){
   ...
   isEmpty(INSTALL_DESKTOP_FILES_PATH):INSTALL_DESKTOP_FILES_PATH = /usr/share/applications/
   isEmpty(INSTALL_DESKTOP_ICON_PATH):INSTALL_DESKTOP_ICON_PATH = /usr/share/pixmaps
