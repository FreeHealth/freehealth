...
const char* const DRUGS_ALLERGIES               = QT_TRANSLATE_NOOP("tkConstants", "Drugs allergies");
const char* const INTOLERANCE_TO_1              = QT_TRANSLATE_NOOP("tkConstants", "Intolerance to %1");
const char* const DRUGS_INTOLERANCES            = QT_TRANSLATE_NOOP("tkConstants", "Drugs intolerances");
...
const char* const ACTIVE_SUBSTANCE              = QT_TRANSLATE_NOOP("tkConstants", "Active substance");
