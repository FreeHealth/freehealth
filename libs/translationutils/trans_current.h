...
const char* const CREATION_DATE_TIME            = QT_TRANSLATE_NOOP("tkConstants", "Creation date & time");
const char* const EPISODE_DATE_TIME             = QT_TRANSLATE_NOOP("tkConstants", "Episode date & time");
