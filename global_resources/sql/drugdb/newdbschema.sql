...
-- Get all infos about interactions (not tested)
--SELECT INTERACTIONS.IAID, INTERACTIONS.ATC_ID1, INTERACTIONS.ATC_ID2, LABELS.LABEL
--FROM INTERACTIONS
--JOIN IA_IAK ON IA_IAK.IAID=INTERATIONS.IAID
--JOIN IAKNOWLEDGE ON IAKNOWLEDGE.IAKID=IA_IAK.IAKID
--JOIN LABELS_LINK ON LABELS_LINK.MASTER_LID=IA_IAK.MASTER_LID
