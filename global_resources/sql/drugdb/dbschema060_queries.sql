...
-- Find drugs according to their molecular inn names
...
-- Find drugs according to their molecular names
...
-- Get all PIMS_RELATED_ATC.ATC_ID for a specified source
SELECT PIMS_RELATED_ATC.ATC_ID FROM PIMS_RELATED_ATC
JOIN PIMS ON PIMS.PIM_ID=PIMS_RELATED_ATC.PIM_ID
WHERE PIMS.PIM_SID = 1;
