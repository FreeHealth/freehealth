...
QString PathPreferencesPage::id() const
{
    return objectName();
}

QString PathPreferencesPage::displayName() const
{
    return tkTr(Trans::Constants::PATH);
}

QString PathPreferencesPage::category() const
{
