...
bool PatientCore::createDefaultVirtualPatients() const
{
    ...
    d->_base->createVirtualPatient("PICARD", "", "Jean-Luc", "M", 6, QDate(1948, 04, 20), "US", "USS Enterprise-D", "21, StarFleet Command", "1968", "EarthTown", uid, userLkId, "", "", path+"captainpicard.png", QDate(), defaultUuid);

    uid = "ef97f37361824b6f826d5c9246f9dc49";
    d->_base->createVirtualPatient("ARCHER", "", "Jonathan", "M", 6, QDate(1928, 04, 20), "US", "Enterprise (NX-01) commanding officer", "21, StarFleet Command", "1968", "EarthTown", uid, userLkId, "0601020304", "0901020304", path+"captainarcher.jpg", QDate(), defaultUuid);

    uid = "493aa06a1b8745b2ae6c79c531ef12a0";
    d->_base->createVirtualPatient("JANEWAY", "", "Kathryn", "F", 6, QDate(1938, 04, 20), "US", "USS Voyager", "21, StarFleet Command", "1968", "EarthTown", uid, userLkId, "0601020304", "0901020304", path+"captainjaneway.jpg", QDate(), defaultUuid);
    return true;
}
