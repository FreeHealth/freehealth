...
const char * const  TAG_APPLICATION_LOCAL_COMPLETEFORMS_PATH = "__localCompleteForms__";
const char * const  TAG_APPLICATION_LOCAL_SUBFORMS_PATH      = "__localSubForms__";
