...
const char * const  ICONFREEGUARD      = "freeguard.png";
...
const char * const  ICONPRINTDARK =    "printfiledark.png";
const char * const  ICONPRINTLIGHT =   "printfilelight.png";
...
const char * const  ICONLOCK_BLACKWHITE = "lock-bw.png";
const char * const  ICONUNLOCK_BLACKWHITE = "unlock-bw.png";
...
const char * const  ICONHERMAPHRODISM = "hermaphrodism.png";
