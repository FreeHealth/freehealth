 ...
 ***************************************************************************/
#ifndef ACCOUNT2_BANKACCOUNTMODEL_H
#define ACCOUNT2_BANKACCOUNTMODEL_H
...
public:
    ...
    BankAccountModel(QObject *parent);
    ~BankAccountModel();
    ...
    bool setFilter(const QString &userUid);
...
private:
    Internal::BankAccountModelPrivate *d;
};
...
#endif // ACCOUNT2_BANKACCOUNTMODEL_H
